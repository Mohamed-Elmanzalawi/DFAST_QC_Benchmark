...
header = ['query_accession','DFAST_QC_accession', 'DFAST_QC_gtdb_species','DFAST_QC_ani', 'ani_circumscription_radius', 
        'DFAST_QC_status', "Result_Consistency",'dfastqc_match']
