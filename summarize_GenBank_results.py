...
def summary_results(result_folder,assembly_summary,ani_report):
    ...
    df = pd.merge(df, assembly_genebank[['#assembly_accession','relation_to_type_material','version_status']], left_on='query_accession', right_on='#assembly_accession', how='left')
